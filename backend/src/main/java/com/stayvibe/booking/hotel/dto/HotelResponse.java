...
public class HotelResponse {
    ...
    public static HotelResponse from(Hotel hotel) {
        return from(hotel, Collections.emptyList());
    }

    public static HotelResponse from(Hotel hotel, List<Room> rooms) {
        ...
        if (rooms != null && !rooms.isEmpty()) {
            response.setRooms(rooms.stream().map(HotelRoomDetailResponse::from).toList());
        }
        return response;
    }
